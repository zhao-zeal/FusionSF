...
# with the paper-best VQ setting (power and satellite on, NWP off).
# Usage: bash scripts/run_night01z_legacy_zeroshot_vq_paper_best.sh [GPU_ID]

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
PYTHON_BIN="/home/zhaopp/miniconda3/envs/FusionSF/bin/python"
GPU_ID="${1:-2}"
TASK_NAME="fusionSF_legacy_zeroshot_vq_paper_best_20260806_seed42"
