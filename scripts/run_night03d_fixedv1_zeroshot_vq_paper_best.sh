...
# fixed_v1 cross-site run: train sites 10-19, unseen test sites 0-9,
# paper-best VQ (power and satellite on, NWP off).
# Usage: bash scripts/run_night03d_fixedv1_zeroshot_vq_paper_best.sh [GPU_ID]
